...
public class MenuDieta {
    ...
    public MenuDieta(List<String> desayuno,List<String> almuerzo , List<String> comida, List<String> merienda, List<String> cena, int kcal) {
    ...
    public List<String> getAlmuerzo(){return almuerzo;}
    ...
    public List<String> getMerienda() {return merienda;}

    public List<String>  getCena() {return cena;}
